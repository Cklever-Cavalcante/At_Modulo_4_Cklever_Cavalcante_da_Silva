...
public class CoDestinos extends HttpServlet {
	...
	protected void adicionarContato(HttpServletRequest request, HttpServletResponse response)
		...
		contato.setPaís(request.getParameter("país"));
	...
	protected void listarContato(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("país", contato.getPaís());
	...
	protected void gerarRelatorio(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PdfPCell col3 = new PdfPCell(new Paragraph("País"));
			tabela.addCell(col1);
			tabela.addCell(col2);
			tabela.addCell(col3);
			ArrayList<JbDestinos> lista = dao.listarContatos();
			for (int i = 0; i < lista.size(); i++) {
				...
				tabela.addCell(lista.get(i).getPaís());
			}
